...
- Clone this repo
- Download and install "cursor" IDE from the site: www.cursor.com
- You can use the free version
- During the installation select the two options:
- Add "Open with Cursor" actions
...
- Run "uv sync" to syncronize the folder content
